...
<head>
    ...
    <title>Módulos > Horarios</title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="CSS/fontawesome.css">
    <link rel="stylesheet" href="CSS/custom.css">
    <link rel="stylesheet" href="CSS/bootstrap.min.css">
    <link rel="stylesheet" href="CSS/slick-theme.css">
     <link rel="stylesheet" href="CSS/styles_modulos_horarios.css">
    <script src="JS/modulos-horarios.js" defer></script>
...
<body>
    ...
    <header>
        ...
        <div class="actions">
            ...
            <button onclick="window.location.href='pagina_inicial.php'">pagina Principal</button>
        </div>
    </header>
    <br><br><br><br><br><br>
    <div class="container">
        <h1>Módulos > Horarios</h1>
        <button class="add-record add-button" onclick="window.location.href='modulos-horarios-edición.php'">Agregar horario</button>
        ...
        <table>
            ...
            <tbody id="horarios-table">
                <!-- Se llenará dinámicamente con PHP -->
            </tbody>
        </table>
        ...
        <div class="footer-controls">
            ...
            <div>
                ...
                <button onclick="goToPage()">Ir a página</button>
            </div>
        </div>
    </div>
    <footer>
