...
<head>
    ...
    <title>Correspondencia > Administración</title>
...
<link rel="stylesheet" href="css/fontawesome.min.css">
    ...
    <link rel="stylesheet" href="CSS/styles_correspondencia_administracion.css">    
    <script src="JS/Correspondencia-administracion.js" defer></script>
...
<body>
    <div class="container">
        <h2 style="text-align: center;">Correspondencia > Administración</h2>
        ...
        <div class="table-header">
            ...
            <div class="controls">
               ...
               <button class="add-button" onclick="window.location.href='Correspondencia-administracion-Creación.php'">Agregar Correspondencia</button>
            </div>
        </div>

<!-- Tabla dinámica -->
<table class="correspondencia-table">
  <thead>
    <tr>
      ...
      <th scope="col">Código de Envío</th>
      <th scope="col">Entregado por</th>
      <th scope="col">Enviar Correo</th>
      <th scope="col">Acciones</th>
    </tr>
  </thead>
  <tbody id="correspondencia-body">
    <!-- Datos insertados dinámicamente desde la base de datos -->
  </tbody>
</table>

<script>
  // Cargar datos dinámicamente desde PHP
  fetch('cargar_correspondencia.php')
    .then(res => res.json())
    .then(data => {
      const tbody = document.getElementById('correspondencia-body');
      tbody.innerHTML = "";
      data.forEach(item => {
...
<footer>
   ...
   <footer class="bg-dark" id="templatemo_footer">           
            <div class=" text-light col-md-4 pt-0">       
