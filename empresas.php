...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="CSS/styles_empresas.css">
...
<!-- Contenido principal -->
<div class="container">
    <h2>empresas > Creación y Edición</h2>
  <form id="empresaForm">
  <label for="nombre">Nombre Empresa:</label>
  <input type="text" id="nombre" name="nombre_empresa" required><br>

  <label for="nit">NIT:</label>
  <input type="text" id="nit" name="nit" required><br>

  <label for="telefono">Teléfono:</label>
  <input type="text" id="telefono" name="telefono_empresa" required><br>

  <label for="direccion">Dirección:</label>
  <input type="text" id="direccion" name="direccion_empresa" required><br>
...
<script>
 ...
 <footer class="footer-custom bg-dark text-light">
    <div class="footer-content">
        <h2 class="footer-title">INVIZA control de acceso</h2>
        <div class="contact-info">
            ...
            <div class="contact-item">
                <i class="fa fa-envelope mx-2"></i>
                <a href="publicidad.html" class="text-light text-decoration-none">contacto: INVIZA@gmail.com</a>
            </div>
            <div class="contact-item">
                <i class="fa fa-phone mx-2"></i>
                <a href="tel:3125843540" class="text-light text-decoration-none">3125843540</a>
            </div>
        </div>
    </div>

    <div class="footer-bottom bg-dark py-3">
        <p class="m-0">&copy; 2024 - ProdArt | Diseñado por: Rubiel Quintero - David Andres Correa</p>
    </div>
</footer>
