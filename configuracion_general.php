...
<link rel="stylesheet" href="CSS/templatemo.min.css">
        <link rel="stylesheet" href="CSS/styles_pagina_inicial.css">
        ...
        <div class="main-content">
            <div class="modules-grid">
                <div class="module-item">
                    <a href="configuración datos.php">
                        <img src="IMAGENES/configuracion datos.jpg" alt="Configuración Datos">
                        <span>Configuración Datos</span>
                    </a>
                </div>
                <div class="module-item">
                    <a href="configuración-datos-edición.php">
                        <img src="IMAGENES/configuracion edicion.jpg" alt="Configuración Datos Edición">
                        <span>Configuración Datos Edición</span>
                    </a>
                </div>
                <div class="module-item">
                    <a href="configuración-variables.php">
                        <img src="IMAGENES/configuracion variables.jpg" alt="Configuración Variables">
                        <span>Configuración Variables</span>
                    </a>
                </div>
            <div class="module-item">
    <form action="subir_archivo.php" method="POST" enctype="multipart/form-data">
        <a href="#">
            <img src="IMAGENES/inviza.jpg" alt="Subir Archivo">
         </a>
